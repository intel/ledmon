...
=head2 B<-B> or B<--best-controller>
...
The returned controller type is used by subset of routines which not taking controller type
directly (ledctl IBPI mode, ledmon daemon).
