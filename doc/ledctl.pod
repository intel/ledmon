...
=item B<-P> or B<--list-slots> B<--controller-type>=I<controller>
...
=item B<-G> or B<--get-slot> B<--controller-type>=I<controller> B<--device>=I<device>

Displays slot details of given device. I<device> is devnode of selected drive.

=item B<-G> or B<--get-slot> B<--controller-type>=I<controller> B<--slot>=I<slot>

Displays details of given slot. I<slot> is unique slot identifier.

=item B<-S> or B<--set-slot> B<--controller-type>=I<controller> B<--slot>=I<slot> B<--state>=I<IBPI_state>
