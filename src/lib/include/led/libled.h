...
typedef enum  {
	...
	LED_STATUS_BUFFER_OVERFLOW = 1,
	LED_STATUS_NULL_POINTER = 2,
	LED_STATUS_OUT_OF_MEMORY = 3,
	LED_STATUS_OUT_OF_RANGE = 4,
	LED_STATUS_INVALID_NODE = 5,
	LED_STATUS_DATA_ERROR = 6,
	LED_STATUS_IBPI_DETERMINE_ERROR = 7,
	LED_STATUS_INVALID_PATH = 8,
	LED_STATUS_INVALID_SUBOPTION = 9,
	LED_STATUS_INVALID_STATE = 10,
	LED_STATUS_SIZE_ERROR = 11,
	LED_STATUS_FILE_OPEN_ERROR = 12,
	LED_STATUS_FILE_READ_ERROR = 13,
	LED_STATUS_FILE_WRITE_ERROR = 14,
	LED_STATUS_FILE_LOCK_ERROR = 15,
	LED_STATUS_DIR_OPEN_ERROR = 16,
	LED_STATUS_SYSFS_PATH_ERROR = 17,
	LED_STATUS_SYSFS_INIT_ERROR = 18,
	LED_STATUS_SYSFS_SCAN_ERROR = 19,
	LED_STATUS_SYSFS_RESET_ERROR = 20,
	...
	LED_STATUS_MEMBER_LIST_ERROR = 26,
	...
	LED_STATUS_SLOTS_LIST_ERROR = 38,
